...
const screens: ScreenDoc[] = [
  ...
  },
  {
    ...
    description: "Tela de planejamento de veículos.",
    type: "generic-schema",
    endpoints: [
      { method: "GET", path: "/VehiclePlanning", description: "Lista planejamento de veículos" },
    ],
    sharedComponents: [],
  },
  ...
  // --- Monitoramento ---
  {
    ...
    description: "Monitoramento de saídas e chegadas de veículos.",
    type: "generic-schema",
    endpoints: [
      { method: "GET", path: "/DeparturesAndArrivals", description: "Lista saídas/chegadas" },
    ],
    sharedComponents: [],
  },
  {
  ...
  {
    title: "Requisição de Motoristas",
    route: "/drivers-request",
    component: "GenericPage.tsx",
    menuGroup: "Escala de Motoristas",
    description: "Tela de requisição de motoristas.",
    type: "generic-schema",
    endpoints: [
      { method: "GET", path: "/DriversRequest", description: "Lista requisições" },
    ],
    sharedComponents: [],
  },
  {
    ...
    component: "GenericPage.tsx",
    menuGroup: "Escala de Motoristas",
    description: "Tela de escala de motoristas.",
    type: "generic-schema",
    endpoints: [
      { method: "GET", path: "/DriversSchedule", description: "Lista escalas" },
    ],
    sharedComponents: [],
  },
  {
    ...
    component: "GenericPage.tsx",
    menuGroup: "Escala de Motoristas",
    description: "Publicação de jornadas de motoristas.",
    type: "generic-schema",
    endpoints: [
      { method: "GET", path: "/PublishJourney", description: "Lista jornadas" },
    ],
    sharedComponents: [],
  },
  ...
  },
  {
    ...
    menuGroup: "Importações",
    description: "Upload de arquivos Excel (.xlsx, .xls, .csv) para importação de mapas logísticos.",
    type: "custom",
    endpoints: [
      { method: "POST", path: "/Journey/ImportMap", description: "Envia arquivo de mapa para processamento" },
    ],
    sharedComponents: [],
    features: ["Upload drag-and-drop", "Barra de progresso", "Validação de extensão de arquivo"],
  },
